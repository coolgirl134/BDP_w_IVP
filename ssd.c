...
int  main()
{
    ...
    // SET_BIT(ssd->channel_head[0].chip_head[0].die_head[1].plane_head[0].cell_bitmap,257);
    // printf("%d\n",find_next_bit(ssd->channel_head[0].chip_head[0].die_head[1].plane_head[0].cell_bitmap,ssd->parameter->block_plane* ssd->parameter->page_block,256));
